    ...
    <div className='my-64'>
        ...
        <div className='w-[75%] mx-auto relative'> 
            ...
            <Details
                    ...
                    address="Remote"
                    work="Worked on the MLOps team responsible for developing automated cloud solutions for data scientists, including migrating projects from hadoop servers to AWS cloud, building out tools for ML model inference and monitoring."
                />
            ...
            <Details
                ...
                <Details
                    ...
                    time="2020-2022"
                    address="Irvine, CA"
                    work="Taught multiple course on within the chemistry department, held office hours to help students with assignments, and graded exams and assignments. Tutored students outside of the classroom. Courses tutored included: General Chemistry, Inorganic Chemistry, Computational Chemistry, Organic Chemistry, Physical Chemistry, Applied Statistics, Calculus 3 and Linear Algebra."
                />
